...
| #18  | fix/docker-dist-path-broken-by-seed-script | Fix crítico: `nest build` compilaba `scripts/` y rompía `dist/main.js` en Docker desde el PR #16 | Mergeado | 2026-08-20 |
