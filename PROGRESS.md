...
| #7   | feat/docker-single-container | Docker: un solo contenedor (frontend+backend+SQLite), `docker-compose up`, volumen persistente, límite de memoria | Esperando aprobación | 2026-08-20 |
